...
import type { Submission } from "../../interface/student";
...
const ViewSingleTask = () => {
  ...
  const { data, totalCount, error, loading } = useFetchStudentsByTaskId(
    taskData.id || id,
    page,
    limit,
    debouncedSearchTerm
                  ...
                  <div className="flex items-center gap-3 p-4 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-blue-600 font-semibold">
                        {formatDate(taskData.assignedDate)}
                      </p>
                    </div>
                  </div>
                  ...
                  {taskData.attachments?.length > 0 && (
                    <div>
                      ...
                      <div className="grid gap-3">
                        {taskData.attachments.map((attachment:string, index:string) => (
                          <div
                            key={index}
                  ...
                  {taskData.images?.length > 0 && (
                    <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        {taskData.images.map((imageUrl:string, index:string) => (
                          <div
                            key={index}
