...
const ViewStudentAnswer = () => {
  ...
  console.log("ANSWERDATAA",submittedStudent);
      ...
      <div className="bg-white shadow-sm border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center gap-4">
            <button onClick={() => navigate(-1)} className="flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors duration-200 text-gray-600 hover:text-gray-800">
              <ArrowLeft size={20} />
              Back to Submissions
            </button>
            <div className="flex-1">
              <h1 className="text-2xl font-bold text-gray-800">Student Submission</h1>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-bold text-gray-800">{submittedStudent.name}</h4>
                </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 bg-blue-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-800">{submittedStudent.email}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-800">{submittedStudent.class}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-3 p-3 bg-green-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-800">{formatDate(submittedStudent.submissionDate)}</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-3">
                <button className="w-full flex items-center gap-3 p-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all duration-200 shadow-sm hover:shadow-md">
                  <Award size={18} />
                  Grade Submission
                </button>
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-indigo-600">{studentAnswers?.images?.length || 0}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Attachments</span>
                  <span className="font-bold text-indigo-600">{studentAnswers?.attachments?.length || 0}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-600">Word Count</span>
                  <span className="font-bold text-indigo-600">{studentAnswers?.text.split(' ').length}</span>
                </div>
              </div>
            </div>
          </div>
